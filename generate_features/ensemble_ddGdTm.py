...
def main(af2_pickle_file, saved_folder):
    ...
    data["fitness"] = {"dynamic_embedding": wt_dynamic_embedding.unsqueeze(0), "fixed_embedding": torch.cat((wt_fixed_embedding, plddt.unsqueeze(-1)), dim=-1).unsqueeze(0), "pair": wt_pair.unsqueeze(0), "pos14": wt_pos14.unsqueeze(0), "atom_mask": wt_atom_mask.unsqueeze(0), "logits": all_logits.unsqueeze(0), "seq": wt_seq}
